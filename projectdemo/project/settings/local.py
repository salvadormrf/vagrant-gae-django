...
# CSP settings
# Show media from local Appengine service.
CSP_IMG_SRC += ("0.0.0.0:8080", "projectdemo.dev:8080", 'blob:',)
CSP_CONNECT_SRC += ("0.0.0.0:8080", "projectdemo.dev:8080",)
CSP_MEDIA_SRC += ("0.0.0.0:8080", "projectdemo.dev:8080",)
